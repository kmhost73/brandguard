...
const WelcomeGuide: React.FC<WelcomeGuideProps> = ({ onStartExample }) => {
  return (
    <div className="bg-primary/5 border-2 border-dashed border-primary/20 p-6 rounded-lg text-center mb-6 animate-fade-in">
      <h2 className="text-2xl font-bold text-gray-900">Welcome to the BrandGuard AI Demo!</h2>
